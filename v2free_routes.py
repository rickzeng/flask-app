...
# 尝试导入自动化模块
try:
    from v2free_automation import V2freeAutomation, run_login
...
def register_v2free_blueprint(app):
    ...
    def index():
        ...
        return render_template('v2free/index.html', 
                             logs=logs,
    ...
    def api_prepare():
        ...
        try:
            ...
            if result.get('captcha_image'):
                result['captcha_image_url'] = f'/v2free/screenshot/{result["captcha_image"]}'
        ...
        try:
            ...
            return jsonify({
                ...
                'config': {
                    ...
                    'proxy_server': config.PROXY_SERVER if config.USE_PROXY else None
                },
                'timestamp': datetime.now().isoformat()
            })
