    ...
    def _generate_fund_flow(self, realtime_data: Dict, history_data: List[Dict]) -> Dict:
        ...
        try:
            ...
            fund_flow = {
                ...
                'total_inflow': (main_inflow + large_inflow + medium_inflow + small_inflow),
            }
...
if __name__ == '__main__':
    # 测试股票数据获取器
    fetcher = StockDataFetcherHybrid(real_time_source='tencent', history_source='baostock', use_cache=True)
    ...
    for stock in top_stocks:
        print(f"{stock['rank']}. {stock['name']}({stock['code']}): {stock['current_price']}, 涨跌幅: {stock['change_percent']}%, 资金得分: {stock['fund_flow_score']}")
